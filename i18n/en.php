<?php
return array(
	'webdavNextcloud.meta.name'		=> "Nextcloud Sync Compatibility",
	...
	'webdavNextcloud.config.pathAllowSelf'	=> "Personal space",
	'webdavNextcloud.config.logTitle'	=> "Nextcloud compatibility diagnostics",
	'webdavNextcloud.config.logDesc'	=> "Log Nextcloud compatibility upload and Nginx body file diagnostics",
	'webdavNextcloud.tips.route'		=> "This plugin only handles Nextcloud Desktop sync compatibility routes; classic WebDAV remains handled by the old WebDAV plugin.",
	'webdavNextcloud.tips.nginx'		=> "For large uploads, configure Nginx body file acceleration as described in the README.",
	'webdavNextcloud.tips.auth'		=> "The desktop client uses Kodbox username and password, with the same permissions as the web UI.",
	...
	'webdav.config.nextcloudLogTitle'	=> "Nextcloud compatibility diagnostics",
	'webdav.config.nextcloudLogDesc'	=> "Log Nextcloud compatibility upload and Nginx body file diagnostics",
