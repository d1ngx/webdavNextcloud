<?php
return array(
	'webdavNextcloud.meta.name'		=> "Nextcloud 同步兼容",
	...
	'webdavNextcloud.config.pathAllowSelf'	=> "个人空间",
	'webdavNextcloud.config.logTitle'	=> "Nextcloud兼容诊断日志",
	'webdavNextcloud.config.logDesc'	=> "记录Nextcloud兼容层上传、Nginx body file等诊断日志",
	'webdavNextcloud.tips.route'		=> "本插件只处理Nextcloud Desktop同步兼容入口，普通WebDAV仍由旧WebDAV插件负责。",
	'webdavNextcloud.tips.nginx'		=> "大文件上传建议按README配置Nginx body file加速。",
	'webdavNextcloud.tips.auth'		=> "客户端登录使用Kodbox账号密码，权限与Web端保持一致。",
	...
	'webdav.config.nextcloudLogTitle'	=> "Nextcloud兼容诊断日志",
	'webdav.config.nextcloudLogDesc'	=> "记录Nextcloud兼容层上传、Nginx body file等诊断日志",
